<template>
  <div>
    <div v-if="!isActive" class="footer-button" @click="toogleFooter">
      <svg
        viewBox="0 0 24 24"
        role="presentation"
        aria-hidden="true"
        focusable="false"
        style="height: 15px; width: 15px; fill: currentcolor; margin-right: 10px;"
      >
        <path
          ...
          fill-rule="evenodd"
        /></svg
      >Şartlar, Mahremiyet, Para Birimi ve Daha Fazlası
    </div>
    <div class="footer-button" v-else @click="toogleFooter">
      <svg
        viewBox="0 0 12 12"
        role="presentation"
        aria-hidden="true"
          ...
          <el-row :gutter="20">
            <el-col :span="6">
              ...
              <ul>
                ...
                <li>
                  <a href="#">Çeşitlilik ve Aidiyet</a>
                </li>
                <li>
            ...
            <el-col :span="6">
              ...
              <ul>
                <li>
                  <a href="#">Güven ve Güvenlik</a>
                </li>
                <li>
                  <a href="#">Seyahat Kredisi</a>
                </li>
                <li>
                  <a href="#">Airbnb Citizen</a>
                </li>
                <li>
                  <a href="#">İş Seyahati</a>
                </li>
                <li>
                  <a href="#">Yapılacak Şeyler</a>
                  <span class="badge">Yeni</span>
                </li>
                <li>
                  <a href="#">Airbnbmag</a>
            ...
            <el-col :span="7">
              ...
              <ul>
                <li>
                  <a href="#">Neden Ev Sahipliği Yapmalısınız?</a>
                </li>
                <li>
                  <a href="#">Konukseverlik</a>
                </li>
                <li>
                  <a href="#">Sorumlu Ev Sahipliği</a>
                </li>
                <li>
                  <a href="#">Bir Deneyime ev sahipliği yapın</a>
                  <span class="badge">Yeni</span>
                </li>
                <li>
                  <a href="#">Open Homes</a>
      ...
      <div class="footer-bottom">
        <div class="copyright">
          <svg
            ...
            aria-hidden="true"
            focusable="false"
            style="height: 1.5em; width: 1.5em; fill: rgb(118, 118, 118); margin-right: 10px;"
          >
            <path
        ...
        <div class="footer-actions">
          <el-select v-model="languages[selectedLanguage].name" placeholder="Select">
            <el-option v-for="item in languages" :key="item.id" :label="item.name" :value="item.name"></el-option>
          </el-select>
          <el-select v-model="currencies[selectedCurrency].name" placeholder="Select">
            <el-option v-for="item in currencies" :key="item.id" :label="item.name" :value="item.name"></el-option>
          </el-select>
        </div>
      </div>
    </footer>
...
export default {
  ...
  methods: {
    ...
    async fetchLanguages() {
      const languages = await this.$axios.$get('http://localhost:4000/api/languages')
      this.languages = languages
    },
    async fetchCurrencies() {
      const currencies = await this.$axios.$get('http://localhost:4000/api/currencies')
...
.footer-button {
  ...
  border-radius: 8px;
  color: rgb(34, 34, 34);
  box-shadow: rgba(0, 0, 0, 0.12) 2px 0px 16px;
  z-index: 11;
  cursor: pointer;
